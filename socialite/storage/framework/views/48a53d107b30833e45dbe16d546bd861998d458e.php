...
<?php endif; ?>
		...
		<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-4">
			...
			<ul class="nav navbar-nav navbar-right" id="navbar-right" v-cloak>
				<li class="home-catg"><a href="#">Home</a></li>
				<li class="dropdown home-catg">
					<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Categories <span class="caret"></span></a>
					<ul class="dropdown-menu">
					<li><a href="https://artist.gwiddle.co.uk/public">Artysta</a></li>
					<li><a href="https://bi.socialnetwork.gwiddle.co.uk/public">Business Informatics</a></li>
					<li><a href="https://dpositive.socialnetwork.gwiddle.co.uk/public">D positive</a></li>
					<li><a href="https://litrature.socialnetwork.gwiddle.co.uk/public">LA Literature</a></li>
					</ul>
				</li>
				<li>
